...
mixin _$NotificationResponse {
 ...
 String get id; String get title; String get message;@JsonKey(name: 'read') bool get isRead; DateTime get createdAt;
...
@override
String toString() {
  return 'NotificationResponse(id: $id, title: $title, message: $message, isRead: $isRead, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String title, String message,@JsonKey(name: 'read') bool isRead, DateTime createdAt
});
...
/// Create a copy of NotificationResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? message = null,Object? isRead = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String message, @JsonKey(name: 'read')  bool isRead,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String message, @JsonKey(name: 'read')  bool isRead,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _NotificationResponse():
return $default(_that.id,_that.title,_that.message,_that.isRead,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String message, @JsonKey(name: 'read')  bool isRead,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _NotificationResponse() when $default != null:
return $default(_that.id,_that.title,_that.message,_that.isRead,_that.createdAt);case _:
  return null;
...
class _NotificationResponse implements NotificationResponse {
  const _NotificationResponse({required this.id, required this.title, required this.message, @JsonKey(name: 'read') this.isRead = false, required this.createdAt});
...
/// Create a copy of NotificationResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? message = null,Object? isRead = null,Object? createdAt = null,}) {
